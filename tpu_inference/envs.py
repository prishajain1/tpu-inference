...
if TYPE_CHECKING:
    ...
    USE_FUSED_TP_MOE_KERNEL: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental persistent fused MoE kernel for TP=8 Gemma 4.
    "USE_FUSED_TP_MOE_KERNEL":
    env_bool("USE_FUSED_TP_MOE_KERNEL", default=False),
